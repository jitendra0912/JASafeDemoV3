...
open class SignatureView: UIView {
    ...
    */
    ...
    fileprivate func initialize() {
        let tap:UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(SignatureView.tap(_:)))
        self.addGestureRecognizer(tap)
        
        let pan:UIPanGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(SignatureView.pan(_:)))
