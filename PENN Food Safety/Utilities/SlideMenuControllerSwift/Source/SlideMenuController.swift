...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
      ...
      var opacityframe: CGRect = view.bounds
        ...
        opacityView.autoresizingMask = [UIViewAutoresizing.flexibleHeight, UIView.AutoresizingMask.flexibleWidth]
    ...
    @objc open override func openRight() {
    ...
    @objc @objc open override func toggleLeft() {
        if isLeftOpen() {
            closeLeft()
            setCloseWindowLevel()
